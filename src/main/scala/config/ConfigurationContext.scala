 ...
 *
 * The `ConfigurationContext` encapsulates an instance of [[Configuration]], offering methods to get and set the
 ...
 * }}}
 */
case class ConfigurationContext(configuration: Configuration) {
...
object ConfigurationContext {
  given ConfigurationContext = ConfigurationContext(new Configuration {})
}
